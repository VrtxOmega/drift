...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(e,t,n){let r=new Float32Array(mo),i=new J(0,1,0);return new ea({name:`SphericalGaussianBlur`,defines:{n:mo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:jo(),fragmentShader:`
	...
	`}var Mo=class extends Ft{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Mi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Dl.BlurDirectionX=new q(1,0),Dl.BlurDirectionY=new q(0,1);var Ol,kl,Al,jl,Ml=0,Nl=Math.PI/2,Pl=85,Fl=20,Il=200,Ll=!1,Rl={x:0,y:0},zl=!0,Bl=!1,Vl={},Hl={},Ul=0,Wl=1.5,Gl=[];function Kl(e){Ol=new xn,Ol.background=new Z(0),kl=new Da(65,window.innerWidth/window.innerHeight,.1,600),ql(),Al=new hl({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`,logarithmicDepthBuffer:!0}),Al.setSize(window.innerWidth,window.innerHeight),Al.setPixelRatio(window.devicePixelRatio),Al.sortObjects=!0,Al.outputColorSpace=We;let t=new Tl(Ol,kl),n=new Dl(new q(window.innerWidth,window.innerHeight),1.2,.5,.5);jl=new wl(Al),jl.addPass(t),jl.addPass(n),window.addEventListener(`resize`,Jl),e.addEventListener(`mousedown`,Yl),e.addEventListener(`mousemove`,Xl),e.addEventListener(`mouseup`,Zl),e.addEventListener(`mouseleave`,Zl),e.addEventListener(`wheel`,Ql,{passive:!0}),e.addEventListener(`touchstart`,eu,{passive:!1}),e.addEventListener(`touchmove`,tu,{passive:!1}),e.addEventListener(`touchend`,nu)}function ql(){kl&&(kl.position.set(Pl*Math.sin(Nl)*Math.cos(Ml),Pl*Math.cos(Nl),Pl*Math.sin(Nl)*Math.sin(Ml)),kl.lookAt(0,0,0))}function Jl(){kl.aspect=window.innerWidth/window.innerHeight,kl.updateProjectionMatrix(),Al.setSize(window.innerWidth,window.innerHeight),jl.setSize(window.innerWidth,window.innerHeight)}function Yl(e){Ll=!0,zl=!1,Rl={x:e.clientX,y:e.clientY}}function Xl(e){if(!Ll)return;let t=e.clientX-Rl.x,n=e.clientY-Rl.y;Ml-=t*.005,Nl-=n*.005,Nl=Math.max(.1,Math.min(Math.PI-.1,Nl)),Rl={x:e.clientX,y:e.clientY},ql()}function Zl(){Ll=!1}function Ql(e){Pl+=e.deltaY*.05,Pl=Math.max(Fl,Math.min(Il,Pl)),ql()}var $l={x:0,y:0};function eu(e){e.touches.length===1&&(Ll=!0,zl=!1,$l={x:e.touches[0].clientX,y:e.touches[0].clientY},e.preventDefault())}function tu(e){if(!Ll||e.touches.length!==1)return;let t=e.touches[0].clientX-$l.x,n=e.touches[0].clientY-$l.y;Ml-=t*.005,Nl-=n*.005,Nl=Math.max(.1,Math.min(Math.PI-.1,Nl)),$l={x:e.touches[0].clientX,y:e.touches[0].clientY},ql(),e.preventDefault()}function nu(){Ll=!1}function ru(e){Gl.push(e)}function iu(e){let t=e.clone().normalize();Vl={theta:Ml,phi:Nl,radius:Pl},Hl={theta:Math.atan2(t.z,t.x),phi:Math.acos(t.y/1),radius:Math.max(Fl+5,Pl*.7)},Ul=0,Bl=!0,zl=!1}function au(){Vl={theta:Ml,phi:Nl,radius:Pl},Hl={theta:0,phi:Math.PI/2,radius:85},Ul=0,Bl=!0}function ou(e){return 1-(1-e)**3}function su(){let e=new Za;function t(){requestAnimationFrame(t);let n=e.getDelta(),r=e.getElapsedTime();if(zl&&!Ll&&!Bl&&(Ml+=3e-4,ql()),Bl){Ul+=n/Wl,Ul>=1&&(Ul=1,Bl=!1);let e=ou(Ul);Ml=Vl.theta+(Hl.theta-Vl.theta)*e,Nl=Vl.phi+(Hl.phi-Vl.phi)*e,Pl=Vl.radius+(Hl.radius-Vl.radius)*e,ql()}for(let e of Gl)try{e(n,r)}catch(e){console.error(`Update error:`,e)}jl.render()}t()}function cu(e,t){let n=new Ja,r=new q(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1);return n.setFromCamera(r,kl),n}function lu(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255, 255, 255, 1.0)`),n.addColorStop(.1,`rgba(255, 255, 255, 0.8)`),n.addColorStop(.3,`rgba(200, 210, 255, 0.3)`),n.addColorStop(.6,`rgba(150, 170, 255, 0.05)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Ni(e)}var uu=lu(),du=null,fu=null,pu=null;function mu(){let e=6e3,t=new Float32Array(e*3),n=new Float32Array(e*3);for(let r=0;r<e;r++){let e=100+Math.random()*80,i=Math.random()*Math.PI*2,a=Math.acos(2*Math.random()-1);t[r*3]=e*Math.sin(a)*Math.cos(i),t[r*3+1]=e*Math.cos(a),t[r*3+2]=e*Math.sin(a)*Math.sin(i);let o=Math.random();n[r*3]=.6+o*.35,n[r*3+1]=.6+o*.3,n[r*3+2]=.7+o*.3}let r=new hr;r.setAttribute(`position`,new er(t,3)),r.setAttribute(`color`,new er(n,3)),du=new Ti({vertexColors:!0,size:1.2,sizeAttenuation:!0,transparent:!0,opacity:.85,blending:2,depthWrite:!1,map:uu});let i=new Ai(r,du);return i.renderOrder=-3,Ol.add(i),i}function hu(){let e=8e3,t=new Float32Array(e*3),n=new Float32Array(e*3),r=63*Math.PI/180,i=123*Math.PI/180;for(let a=0;a<e;a++){let e=Math.random()*Math.PI*2,o=95+Math.random()*10,s=(Math.random()-.5)*20,c=(Math.random()-.5)*12,l=o*Math.cos(e)+s,u=c,d=o*Math.sin(e)+s,f=u*Math.cos(r)-d*Math.sin(r),p=u*Math.sin(r)+d*Math.cos(r),m=l*Math.cos(i)-p*Math.sin(i),h=l*Math.sin(i)+p*Math.cos(i);t[a*3]=m,t[a*3+1]=f,t[a*3+2]=h,Math.abs(s)<6?(n[a*3]=.75+Math.random()*.25,n[a*3+1]=.7+Math.random()*.25,n[a*3+2]=.8+Math.random()*.2):(n[a*3]=.55+Math.random()*.25,n[a*3+1]=.5+Math.random()*.2,n[a*3+2]=.65+Math.random()*.3)}let a=new hr;a.setAttribute(`position`,new er(t,3)),a.setAttribute(`color`,new er(n,3)),fu=new Ti({vertexColors:!0,size:.9,sizeAttenuation:!0,transparent:!0,opacity:.2,blending:2,depthWrite:!1,map:uu});let o=new Ai(a,fu);return o.renderOrder=-1,Ol.add(o),o}function gu(e){if(du){let t=.5+.5*Math.sin(e*.4);du.opacity=.6+t*.15}if(fu){let t=.5+.5*Math.sin(e*.25+1);fu.opacity=.12+t*.06}if(pu){let t=.5+.5*Math.sin(e*.15+2);pu.opacity=.06+t*.04;let n=26/255+t*.03,r=10/255+t*.01,i=62/255-t*.02;pu.color.setRGB(n,r,i)}}var _u={JavaScript:new Z(15784783),TypeScript:new Z(4890367),Python:new Z(4950974),Rust:new Z(16739904),Go:new Z(54442),Java:new Z(15167232),"C++":new Z(15944573),C:new Z(6460875),"C#":new Z(6870630),Ruby:new Z(16724787),PHP:new Z(8029880),Swift:new Z(16739133),Kotlin:new Z(11833087),Solidity:new Z(9067765),HTML:new Z(16737095),CSS:new Z(8082900),Shell:new Z(9035857),Dart:new Z(50352),Vue:new Z(4307075),Svelte:new Z(16727552),Makefile:new Z(4356121),Perl:new Z(170179),Assembly:new Z(7228435),default:new Z(9079456)};function vu(e){let t=(e||``).toLowerCase();return/^(feat|add|new|implement|create)/i.test(t)?`feature`:/^(fix|bug|patch|resolve|hotfix)/i.test(t)?`fix`:/^(refactor|clean|restructure|reorganize)/i.test(t)?`refactor`:/^(doc|readme|comment|update doc)/i.test(t)?`docs`:/^(test|spec|coverage)/i.test(t)?`test`:/^(ci|build|deploy|release|bump|version)/i.test(t)?`ci`:/^(style|lint|format)/i.test(t)?`style`:/^merge/i.test(t)?`merge`:`other`}var yu={feature:new Z(4890367),fix:new Z(16755251),refactor:new Z(4902863),docs:new Z(12303325),test:new Z(6088826),ci:new Z(10514165),style:new Z(16740008),merge:new Z(13217899),other:new Z(10070732)},bu=[],xu=new Map,Su=null;function Cu(e){Su=e}function wu(e){if(!Su)return 1;if(e.userData.repoName===Su)return .15;let t=bu.find(e=>e.userData.repoName===Su);if(!t)return 1;let n=e.position.distanceTo(t.position);return n<30?.3:n<60?.6:1}function Tu(e,t,n){let r=e.length,i=Math.PI*(3-Math.sqrt(5)),a=1;for(let[,e]of t)a=Math.max(a,e.length);for(let n=0;n<r;n++){let o=e[n],s=t.get(o.name)||[],c=1-n/(r-1||1)*2,l=Math.sqrt(1-c*c),u=i*n,d=new J(l*Math.cos(u)*50,c*50,l*Math.sin(u)*50),f=Au(o,s,d,a);bu.push(f),xu.set(o.name,{name:o.name,description:o.description||`No description`,language:o.language||`Unknown`,stars:o.stargazers_count,forks:o.forks_count,commits:s.length,lastPush:o.pushed_at,url:o.html_url,position:d})}}var Eu=null,Du=null;function Ou(){let e=new Ki(1.5,24,24);Eu=new Gr({color:new Z(16757575),transparent:!0,opacity:.08,blending:2,depthWrite:!1});let t=new ri(e,Eu);Ol.add(t);let n=new Ki(5,24,24);Du=new Gr({color:new Z(1706558),transparent:!0,opacity:.04,blending:2,depthWrite:!1});let r=new ri(n,Du);Ol.add(r);let i=new Float32Array(600);for(let e=0;e<200;e++){let t=Math.random()*Math.PI*2,n=3+Math.random()*8;i[e*3]=n*Math.cos(t),i[e*3+1]=(Math.random()-.5)*2,i[e*3+2]=n*Math.sin(t)}let a=new hr;a.setAttribute(`position`,new er(i,3));let o=new Ai(a,new Ti({color:16757575,size:.3,sizeAttenuation:!0,transparent:!0,opacity:.12,blending:2,depthWrite:!1}));Ol.add(o)}function ku(e){if(Eu){let t=.5+.5*Math.sin(e*.8);Eu.opacity=.05+t*.06}if(Du){let t=.5+.5*Math.sin(e*.5+1);Du.opacity=.02+t*.03}}function Au(e,t,n,r){let i=new pn;i.position.copy(n),i.userData={repoName:e.name};let a=_u[e.language]||_u.default,o=3+t.length/r*4,s=t.length>15,c=t.length<5?2.5:t.length<15?1.8:t.length<50?1.3:1,l=new ri(new Ki(o*.12,16,16),new Gr({color:a.clone().lerp(new Z(16777215),.3),transparent:!0,opacity:.25,blending:2,depthWrite:!1}));i.add(l);let u=document.createElement(`canvas`);u.width=128,u.height=128;let d=u.getContext(`2d`),f=d.createRadialGradient(64,64,0,64,64,64),p=a;f.addColorStop(0,`rgba(${Math.round(p.r*255)},${Math.round(p.g*255)},${Math.round(p.b*255)},0.2)`),f.addColorStop(.2,`rgba(${Math.round(p.r*255)},${Math.round(p.g*255)},${Math.round(p.b*255)},0.08)`),f.addColorStop(.5,`rgba(${Math.round(p.r*255)},${Math.round(p.g*255)},${Math.round(p.b*255)},0.02)`),f.addColorStop(1,`rgba(0,0,0,0)`),d.fillStyle=f,d.fillRect(0,0,128,128);let m=new Fr(new xr({map:new Ni(u),transparent:!0,blending:2,depthWrite:!1}));if(m.scale.set(o*2.5,o*2.5,1),i.add(m),t.length>0){let e=t.length,n=new Float32Array(e*3),r=new Float32Array(e*3),l=Date.now();for(let i=0;i<e;i++){let c=t[i],u=yu[vu(c.commit?.message||``)],d=(l-new Date(c.commit?.author?.date||l).getTime())/864e5,f,p,m;if(s){let t=i%2,n=i/e,r=t*Math.PI+n*Math.PI*4,a=(.15+n*.85)*o*1.6,s=(Math.random()-.5)*o*.4,c=(Math.random()-.5)*o*.08;f=a*Math.cos(r)+s,p=c,m=a*Math.sin(r)+s}else{let e=Math.random()**.5*o*1.2,t=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1);f=e*Math.sin(n)*Math.cos(t),p=e*Math.cos(n)*.2,m=e*Math.sin(n)*Math.sin(t)}n[i*3]=f,n[i*3+1]=p,n[i*3+2]=m;let h=u.clone().lerp(a,.2),g=Math.min(1,d/180),_=h.lerp(new Z(15247436),g*.12);d<7?_.lerp(new Z(16777215),.3):d<30&&_.lerp(new Z(16777215),.1),r[i*3]=_.r,r[i*3+1]=_.g,r[i*3+2]=_.b}let u=new hr;u.setAttribute(`position`,new er(n,3)),u.setAttribute(`color`,new er(r,3));let d=new Ai(u,new Ti({vertexColors:!0,size:.7*c,sizeAttenuation:!0,transparent:!0,opacity:.95,blending:2,depthWrite:!1}));i.add(d)}if(t.length>5){let e=Math.min(80,t.length),n=new Float32Array(e*3);for(let t=0;t<e;t++){let e=(.5+Math.random())*o*1.3,r=Math.random()*Math.PI*2;n[t*3]=e*Math.cos(r)+(Math.random()-.5)*o*.4,n[t*3+1]=(Math.random()-.5)*o*.12,n[t*3+2]=e*Math.sin(r)+(Math.random()-.5)*o*.4}let r=new hr;r.setAttribute(`position`,new er(n,3));let s=new Ti({color:a.clone().lerp(new Z(16777215),.5),size:.2,sizeAttenuation:!0,transparent:!0,opacity:.15,blending:2,depthWrite:!1});i.add(new Ai(r,s))}return Ol.add(i),i}var ju=[];function Mu(e){let t=e.dailyCommits,n=Object.keys(t).sort();if(n.length<2)return;let r=[],i=[n[0]];for(let e=1;e<n.length;e++){let t=new Date(n[e-1]),a=new Date(n[e]);Math.floor((a-t)/864e5)<=1?i.push(n[e]):(i.length>=4&&r.push([...i]),i=[n[e]])}i.length>=4&&r.push(i),r.sort((e,t)=>t.length-e.length);let a=r.slice(0,5);for(let e=0;e<a.length;e++){let n=a[e],r=Math.min(1,n.length/14),i=n.map(e=>{let t=Math.floor((new Date(e)-new Date(e.slice(0,4)+`-01-01`))/864e5),n=Math.PI*(3-Math.sqrt(5)),r=1-t/365*2,i=Math.sqrt(1-r*r),a=n*t;return new J(i*Math.cos(a)*52,r*52,i*Math.sin(a)*52)}),o=new Wi(i,!1,`centripetal`,.5),s=n.length*8,c=o.getPoints(s),l=new hr().setFromPoints(c),u=new hi({color:new Z(16762960),transparent:!0,opacity:.3+r*.3,blending:2,depthWrite:!1}),d=new Ci(l,u);Ol.add(d);let f=new hi({color:new Z(4890367),transparent:!0,opacity:.06+r*.1,blending:2,depthWrite:!1,linewidth:1}),p=new Ci(l.clone(),f);Ol.add(p);let m=[];for(let e=0;e<i.length;e++){let a=t[n[e]]||1,o=new Ki(.25+Math.min(a/8,.8)+r*.15,10,10),s=Math.min(1,a/10),c=new Gr({color:new Z().lerpColors(new Z(8961023),new Z(16766720),s),transparent:!0,opacity:.6+s*.3,blending:2,depthWrite:!1}),l=new ri(o,c);l.position.copy(i[e]),Ol.add(l),m.push(c)}let h=2+Math.floor(r*3),g=[],_=[],v=[],y=document.createElement(`canvas`);y.width=64,y.height=64;let b=y.getContext(`2d`),x=b.createRadialGradient(32,32,0,32,32,32);x.addColorStop(0,`rgba(255, 255, 255, 1.0)`),x.addColorStop(.08,`rgba(180, 220, 255, 0.95)`),x.addColorStop(.2,`rgba(255, 200, 80, 0.7)`),x.addColorStop(.4,`rgba(255, 170, 50, 0.3)`),x.addColorStop(.65,`rgba(74, 158, 255, 0.08)`),x.addColorStop(1,`rgba(0, 0, 0, 0)`),b.fillStyle=x,b.fillRect(0,0,64,64);let S=new Ni(y);for(let e=0;e<h;e++){let t=new xr({map:S,transparent:!0,blending:2,depthWrite:!1,opacity:0}),n=new Fr(t),a=1+r*1.5;n.scale.set(a,a,1),n.position.copy(i[0]),Ol.add(n),g.push(t),_.push(n),v.push(e/h)}ju.push({curve:o,curveLength:o.getLength(),lineMat:u,glowMat:f,nodeMats:m,pulseSprites:_,pulseMats:g,pulsePhases:v,pulseCount:h,intensity:r,speed:.08+r*.12,nodePositions:i})}}function Nu(e,t){for(let n of ju){let r=.5+.5*Math.sin(t*1.5+n.intensity*10);n.lineMat.opacity=(.2+n.intensity*.25)*(.6+r*.4),n.glowMat.opacity=(.06+n.intensity*.1)*(.4+r*.6);for(let e=0;e<n.nodeMats.length;e++){let r=t*2+e*1.7,i=.5+.5*Math.sin(r);n.nodeMats[e].opacity=.3+i*.6*n.intensity}for(let r=0;r<n.pulseCount;r++){n.pulsePhases[r]+=e*n.speed,n.pulsePhases[r]>1&&--n.pulsePhases[r];let i=n.pulsePhases[r],a=n.curve.getPointAt(i);n.pulseSprites[r].position.copy(a);let o=Math.min(i*5,(1-i)*5,1),s=.7+.3*Math.sin(t*8+r*3.14);n.pulseMats[r].opacity=o*s*(.5+n.intensity*.5);let c=(1+n.intensity*1.5)*(.8+.4*Math.sin(t*6+r*2));n.pulseSprites[r].scale.set(c,c,1)}}}function Pu(e,t,n){let r=1200;e.width=r,e.height=630;let i=e.getContext(`2d`);i.fillStyle=`#060610`,i.fillRect(0,0,r,630);let a=i.createRadialGradient(r/2,630/2,0,r/2,630/2,r*.6);a.addColorStop(0,`rgba(30, 20, 60, 0.3)`),a.addColorStop(1,`rgba(6, 6, 16, 0)`),i.fillStyle=a,i.fillRect(0,0,r,630);try{let e=Al.domElement;i.globalAlpha=.6,i.drawImage(e,0,0,r,630),i.globalAlpha=1}catch{}let o=i.createLinearGradient(0,0,0,630);o.addColorStop(0,`rgba(6, 6, 16, 0.3)`),o.addColorStop(.5,`rgba(6, 6, 16, 0.1)`),o.addColorStop(.85,`rgba(6, 6, 16, 0.7)`),o.addColorStop(1,`rgba(6, 6, 16, 0.9)`),i.fillStyle=o,i.fillRect(0,0,r,630),i.fillStyle=`#c9b06b`,i.font=`500 24px Inter, sans-serif`,i.fillText(`✦`,40,52),i.fillStyle=`#8a8aa0`,i.font=`600 14px Inter, sans-serif`,i.letterSpacing=`4px`,i.fillText(`DRIFT`,68,50),t.avatar_url&&(r-40-40,i.beginPath(),i.arc(1140,50,40/2,0,Math.PI*2),i.fillStyle=`#1a1a2e`,i.fill(),i.strokeStyle=`rgba(201, 176, 107, 0.3)`,i.lineWidth=1,i.stroke()),i.fillStyle=`#e8e6e3`,i.font=`500 14px Inter, sans-serif`,i.textAlign=`right`,i.fillText(`@${t.login}`,r-90,55),i.textAlign=`left`,i.fillStyle=`#c9b06b`,i.font=`300 12px Inter, sans-serif`,i.textAlign=`center`,i.fillText(`✦  Y O U R   U N I V E R S E  ✦`,r/2,630*.45),i.textAlign=`left`;let s=[{value:n.totalCommits.toLocaleString(),label:`COMMITS`},{value:n.totalRepos.toString(),label:`REPOS`},{value:`${n.maxStreak}d`,label:`MAX STREAK`},{value:`${n.topLanguage} (${n.topLanguagePct}%)`,label:`TOP LANGUAGE`},{value:n.activeDays.toString(),label:`ACTIVE DAYS`}],c=r/(s.length+1);s.forEach((e,t)=>{let n=c*(t+.8);i.fillStyle=`#e8e6e3`,i.font=`700 28px Inter, sans-serif`,i.textAlign=`center`,i.fillText(e.value,n,530),i.fillStyle=`#4a4a6a`,i.font=`500 9px Inter, sans-serif`,i.fillText(e.label,n,548)}),i.textAlign=`left`,i.fillStyle=`#4a4a6a`,i.font=`400 10px Inter, sans-serif`,i.textAlign=`center`,i.fillText(`🌀  DRIFT — your code has a pulse  ·  drift.veritas.dev`,r/2,606),i.textAlign=`left`,i.strokeStyle=`rgba(201, 176, 107, 0.15)`,i.lineWidth=1,i.beginPath(),i.moveTo(40,500),i.lineTo(r-40,500),i.stroke()}async function Fu(e){try{let t=await new Promise(t=>e.toBlob(t,`image/png`));return await navigator.clipboard.write([new ClipboardItem({"image/png":t})]),!0}catch{return!1}}function Iu(e,t){let n=document.createElement(`a`);n.download=`drift-${t}-universe.png`,n.href=e.toDataURL(`image/png`),n.click()}var Lu=document.getElementById(`landing`),Ru=document.getElementById(`loading`),zu=document.getElementById(`hud`),Bu=document.getElementById(`toast`),Vu=document.getElementById(`tooltip`),Hu=document.getElementById(`username-input`),Uu=document.getElementById(`launch-btn`),Wu=document.getElementById(`progress-fill`),Gu=document.getElementById(`loading-detail`),Ku=document.getElementById(`hud-user`),qu=document.getElementById(`hud-stats`),Ju=document.getElementById(`share-modal`),Yu=document.getElementById(`share-canvas`),Xu=document.getElementById(`galaxy-panel`),Zu=document.getElementById(`galaxy-detail`),Qu=document.getElementById(`drift-canvas`),$u=null,ed=null;Kl(Qu),mu(),su(),Uu.addEventListener(`click`,td),Hu.addEventListener(`keydown`,e=>{e.key===`Enter`&&td()});async function td(){let e=Hu.value.trim();if(!e){Hu.focus();return}Lu.classList.add(`hidden`),Ru.classList.remove(`hidden`),id(5,`Fetching profile...`);try{let t=await o(e);$u=t,id(15,`Fetching repositories...`);let n=await s(e,e=>id(25,e));if(n.length===0){hu(),id(100,`Empty universe — but something is here, waiting`),await cd(1e3),Ru.classList.add(`hidden`),zu.classList.remove(`hidden`),Ku.textContent=`@${t.login}`,qu.innerHTML=[nd(`0`,`COMMITS`,`stat-commits`),nd(`0`,`REPOS`,`stat-repos`),nd(`—`,`MAX STREAK`,`stat-streak`),nd(`—`,`TOP LANG`),nd(`0`,`ACTIVE DAYS`,`stat-days`)].join(``);return}id(35,`Found ${n.length} repositories`);let r=await l(e,n,e=>{let t=35+Math.round(e.match(/(\d+)%/)?.[1]*.5||0);id(Math.min(85,t),e)});id(88,`Computing statistics...`);let i=u(n,r);ed=i,id(92,`Building galaxies...`),hu(),Ou(),Tu(n,r,i),id(96,`Drawing constellations...`),Mu(i),id(100,`Universe ready`),await cd(500),Ru.classList.add(`hidden`),zu.classList.remove(`hidden`),Ku.textContent=`@${t.login}`,qu.innerHTML=[nd(`0`,`COMMITS`,`stat-commits`),nd(`0`,`REPOS`,`stat-repos`),nd(`0d`,`MAX STREAK`,`stat-streak`),nd(`${i.topLanguage}`,`TOP LANG`),nd(`0`,`ACTIVE DAYS`,`stat-days`)].join(``),rd(`stat-commits`,i.totalCommits,2e3),rd(`stat-repos`,i.totalRepos,1500),rd(`stat-streak`,i.maxStreak,1800,`d`),rd(`stat-days`,i.activeDays,1600),ad()}catch(t){console.error(`Launch error:`,t);let n=`Something went wrong.`;t.message===`USER_NOT_FOUND`?n=`User "${e}" not found on GitHub.`:t.message===`NO_REPOS`?n=`User "${e}" has no public repositories.`:t.message.startsWith(`RATE_LIMITED`)&&(n=`GitHub API rate limited. ${t.message.split(`: `)[1]}`),sd(n),Ru.classList.add(`hidden`),Lu.classList.remove(`hidden`)}}function nd(e,t,n=``){return`<div class="stat-item"><div class="stat-value"${n?` id="${n}"`:``}>${e}</div><div class="stat-label">${t}</div></div>`}function rd(e,t,n=1500,r=``){let i=document.getElementById(e);if(!i)return;let a=performance.now();function o(e){let s=e-a,c=Math.min(s/n,1),l=1-(1-c)**4;i.textContent=Math.floor(l*t).toLocaleString()+r,c<1?requestAnimationFrame(o):i.textContent=t.toLocaleString()+r}requestAnimationFrame(o)}function id(e,t){Wu.style.width=`${e}%`,Gu.textContent=t}document.getElementById(`btn-home`).addEventListener(`click`,()=>{au(),Xu.classList.add(`hidden`)}),document.getElementById(`btn-share`).addEventListener(`click`,()=>{!$u||!ed||(Pu(Yu,$u,ed),Ju.classList.remove(`hidden`))}),document.getElementById(`btn-back`).addEventListener(`click`,()=>{window.location.reload()}),document.getElementById(`close-share`).addEventListener(`click`,()=>{Ju.classList.add(`hidden`)}),document.getElementById(`btn-copy-share`).addEventListener(`click`,async()=>{sd(await Fu(Yu)?`✦ Copied to clipboard`:`Copy failed — try download instead`)}),document.getElementById(`btn-download-share`).addEventListener(`click`,()=>{Iu(Yu,$u?.login||`user`),sd(`✦ Downloaded`)}),document.getElementById(`close-galaxy`).addEventListener(`click`,()=>{Xu.classList.add(`hidden`)});function ad(){let e=null;Qu.addEventListener(`mousemove`,t=>{let n=cu(t.clientX,t.clientY),r=null;for(let e of bu)if(n.intersectObjects(e.children,!0).length>0){r=e.userData.repoName;break}if(r&&r!==e){e=r,Cu(r);let t=xu.get(r);if(t){let e=ud(t.lastPush,t.commits);Vu.innerHTML=`
        ...
        `,Vu.classList.remove(`hidden`)}Qu.style.cursor=`pointer`}else !r&&e&&(e=null,Cu(null),Vu.classList.add(`hidden`),Qu.style.cursor=`grab`);Vu.classList.contains(`hidden`)||(Vu.style.left=`${t.clientX+16}px`,Vu.style.top=`${t.clientY-10}px`)}),Qu.addEventListener(`click`,e=>{let t=cu(e.clientX,e.clientY);for(let e of bu)if(t.intersectObjects(e.children,!0).length>0){let t=e.userData.repoName,n=xu.get(t);n&&(iu(n.position),od(n));break}})}function od(e){Zu.innerHTML=`
    ...
    <div class="galaxy-meta">
      ...
      <div class="galaxy-meta-item">Last push <strong>${ld(e.lastPush)}</strong></div>
    </div>
  `,Xu.classList.remove(`hidden`)}function sd(e){Bu.textContent=e,Bu.classList.remove(`hidden`),setTimeout(()=>Bu.classList.add(`hidden`),3500)}function cd(e){return new Promise(t=>setTimeout(t,e))}function ld(e){if(!e)return`unknown`;let t=new Date(e),n=new Date,r=Math.floor((n-t)/864e5);return r===0?`today`:r===1?`yesterday`:r<7?`${r}d ago`:r<30?`${Math.floor(r/7)}w ago`:r<365?`${Math.floor(r/30)}mo ago`:`${Math.floor(r/365)}y ago`}ru((e,t)=>{for(let t of bu){let n=wu(t);t.rotation.y+=e*.05*n}Nu(e,t),gu(t),ku(t)});function ud(e,t){if(!e)return{label:`unknown`,class:`dormant`};let n=Math.floor((Date.now()-new Date(e).getTime())/864e5);return n<=1&&t>20?{label:`🔥 exploding`,class:`alive`}:n<=1?{label:`⚡ firing`,class:`alive`}:n<=7&&t>20?{label:`⚡ surging`,class:`alive`}:n<=7?{label:`✨ active`,class:`active`}:n<=30?{label:`quiet`,class:`quiet`}:n<=90&&t<5?{label:`🌱 emerging`,class:`active`}:n<=90?{label:`resting`,class:`quiet`}:n<=365&&t<3?{label:`🌱 emerging`,class:`active`}:n<=365?{label:`dormant`,class:`dormant`}:t>50?{label:`archived`,class:`dormant`}:{label:`deep sleep`,class:`dormant`}}