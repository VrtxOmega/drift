...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};zl.BlurDirectionX=new K(1,0),zl.BlurDirectionY=new K(0,1);var Bl,Vl,Hl,Ul,Wl=0,Gl=Math.PI/2,Kl=85,ql=20,Jl=200,Yl=!1,Xl={x:0,y:0},Zl=!0,Ql=!1,$l={},eu={},tu=0,nu=1.5,ru=[];function iu(e){Bl=new xn,Bl.background=new Z(0),Vl=new za(65,window.innerWidth/window.innerHeight,.1,600),au(),Hl=new Dl({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`,logarithmicDepthBuffer:!0,preserveDrawingBuffer:!0}),Hl.setSize(window.innerWidth,window.innerHeight),Hl.setPixelRatio(window.devicePixelRatio),Hl.sortObjects=!0,Hl.outputColorSpace=Ge;let t=new Ll(Bl,Vl),n=new zl(new K(window.innerWidth,window.innerHeight),.6,.3,.6);Ul=new Il(Hl),Ul.addPass(t),Ul.addPass(n),window.addEventListener(`resize`,ou),e.addEventListener(`mousedown`,su),e.addEventListener(`mousemove`,cu),e.addEventListener(`mouseup`,lu),e.addEventListener(`mouseleave`,lu),e.addEventListener(`wheel`,uu,{passive:!0}),e.addEventListener(`touchstart`,fu,{passive:!1}),e.addEventListener(`touchmove`,pu,{passive:!1}),e.addEventListener(`touchend`,mu)}function au(){Vl&&(Vl.position.set(Kl*Math.sin(Gl)*Math.cos(Wl),Kl*Math.cos(Gl),Kl*Math.sin(Gl)*Math.sin(Wl)),Vl.lookAt(0,0,0))}function ou(){Vl.aspect=window.innerWidth/window.innerHeight,Vl.updateProjectionMatrix(),Hl.setSize(window.innerWidth,window.innerHeight),Ul.setSize(window.innerWidth,window.innerHeight)}function su(e){Yl=!0,Zl=!1,Xl={x:e.clientX,y:e.clientY}}function cu(e){if(!Yl)return;let t=e.clientX-Xl.x,n=e.clientY-Xl.y;Wl-=t*.005,Gl-=n*.005,Gl=Math.max(.1,Math.min(Math.PI-.1,Gl)),Xl={x:e.clientX,y:e.clientY},au()}function lu(){Yl=!1}function uu(e){Kl+=e.deltaY*.05,Kl=Math.max(ql,Math.min(Jl,Kl)),au()}var du={x:0,y:0};function fu(e){e.touches.length===1&&(Yl=!0,Zl=!1,du={x:e.touches[0].clientX,y:e.touches[0].clientY},e.preventDefault())}function pu(e){if(!Yl||e.touches.length!==1)return;let t=e.touches[0].clientX-du.x,n=e.touches[0].clientY-du.y;Wl-=t*.005,Gl-=n*.005,Gl=Math.max(.1,Math.min(Math.PI-.1,Gl)),du={x:e.touches[0].clientX,y:e.touches[0].clientY},au(),e.preventDefault()}function mu(){Yl=!1}function hu(e){ru.push(e)}function gu(e){let t=e.clone().normalize();$l={theta:Wl,phi:Gl,radius:Kl},eu={theta:Math.atan2(t.z,t.x),phi:Math.acos(t.y),radius:Math.max(ql+5,Kl*.7)},tu=0,Ql=!0,Zl=!1}function _u(){$l={theta:Wl,phi:Gl,radius:Kl},eu={theta:0,phi:Math.PI/2,radius:85},tu=0,Ql=!0}function vu(e){return 1-(1-e)**3}function yu(){let e=new lo;function t(){requestAnimationFrame(t);let n=e.getDelta(),r=e.getElapsedTime();if(Zl&&!Yl&&!Ql&&(Wl+=3e-4,au()),Ql){tu+=n/nu,tu>=1&&(tu=1,Ql=!1);let e=vu(tu);Wl=$l.theta+(eu.theta-$l.theta)*e,Gl=$l.phi+(eu.phi-$l.phi)*e,Kl=$l.radius+(eu.radius-$l.radius)*e,au()}for(let e of ru)try{e(n,r)}catch(e){console.error(`Update error:`,e)}Ul.render()}t()}function bu(e,t,n){n||=new oo;let r=new K(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1);return n.setFromCamera(r,Vl),n}function xu(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255, 255, 255, 1.0)`),n.addColorStop(.1,`rgba(255, 255, 255, 0.8)`),n.addColorStop(.3,`rgba(200, 210, 255, 0.3)`),n.addColorStop(.6,`rgba(150, 170, 255, 0.05)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Hi(e)}var Su=xu(),Cu=null,wu=null,Tu=null;function Eu(){let e=6e3,t=new Float32Array(e*3),n=new Float32Array(e*3);for(let r=0;r<e;r++){let e=100+Math.random()*80,i=Math.random()*Math.PI*2,a=Math.acos(2*Math.random()-1);t[r*3]=e*Math.sin(a)*Math.cos(i),t[r*3+1]=e*Math.cos(a),t[r*3+2]=e*Math.sin(a)*Math.sin(i);let o=Math.random();n[r*3]=.6+o*.35,n[r*3+1]=.6+o*.3,n[r*3+2]=.7+o*.3}let r=new hr;r.setAttribute(`position`,new er(t,3)),r.setAttribute(`color`,new er(n,3)),Cu=new Pi({vertexColors:!0,size:1.2,sizeAttenuation:!0,transparent:!0,opacity:.85,blending:2,depthWrite:!1,map:Su});let i=new zi(r,Cu);return i.renderOrder=-3,Bl.add(i),i}function Du(){let e=8e3,t=new Float32Array(e*3),n=new Float32Array(e*3),r=63*Math.PI/180,i=123*Math.PI/180;for(let a=0;a<e;a++){let e=Math.random()*Math.PI*2,o=95+Math.random()*10,s=(Math.random()-.5)*20,c=(Math.random()-.5)*12,l=o*Math.cos(e)+s,u=c,d=o*Math.sin(e)+s,f=u*Math.cos(r)-d*Math.sin(r),p=u*Math.sin(r)+d*Math.cos(r),m=l*Math.cos(i)-p*Math.sin(i),h=l*Math.sin(i)+p*Math.cos(i);t[a*3]=m,t[a*3+1]=f,t[a*3+2]=h,Math.abs(s)<6?(n[a*3]=.75+Math.random()*.25,n[a*3+1]=.7+Math.random()*.25,n[a*3+2]=.8+Math.random()*.2):(n[a*3]=.55+Math.random()*.25,n[a*3+1]=.5+Math.random()*.2,n[a*3+2]=.65+Math.random()*.3)}let a=new hr;a.setAttribute(`position`,new er(t,3)),a.setAttribute(`color`,new er(n,3)),wu=new Pi({vertexColors:!0,size:.9,sizeAttenuation:!0,transparent:!0,opacity:.2,blending:2,depthWrite:!1,map:Su});let o=new zi(a,wu);return o.renderOrder=-1,Bl.add(o),o}function Ou(e){if(Cu){let t=.5+.5*Math.sin(e*.4);Cu.opacity=.6+t*.15}if(wu){let t=.5+.5*Math.sin(e*.25+1);wu.opacity=.12+t*.06}if(Tu){let t=.5+.5*Math.sin(e*.15+2);Tu.opacity=.06+t*.04;let n=26/255+t*.03,r=10/255+t*.01,i=62/255-t*.02;Tu.color.setRGB(n,r,i)}}var ku={JavaScript:new Z(15784783),TypeScript:new Z(4890367),Python:new Z(4950974),Rust:new Z(16739904),Go:new Z(54442),Java:new Z(15167232),"C++":new Z(15944573),C:new Z(6460875),"C#":new Z(6870630),Ruby:new Z(16724787),PHP:new Z(8029880),Swift:new Z(16739133),Kotlin:new Z(11833087),Solidity:new Z(9067765),HTML:new Z(16737095),CSS:new Z(8082900),Shell:new Z(9035857),Dart:new Z(50352),Vue:new Z(4307075),Svelte:new Z(16727552),Makefile:new Z(4356121),Perl:new Z(170179),Assembly:new Z(7228435),default:new Z(9079456)};function Au(e){let t=(e||``).toLowerCase();return/^(feat|add|new|implement|create)/i.test(t)?`feature`:/^(fix|bug|patch|resolve|hotfix)/i.test(t)?`fix`:/^(refactor|clean|restructure|reorganize)/i.test(t)?`refactor`:/^(doc|readme|comment|update doc)/i.test(t)?`docs`:/^(test|spec|coverage)/i.test(t)?`test`:/^(ci|build|deploy|release|bump|version)/i.test(t)?`ci`:/^(style|lint|format)/i.test(t)?`style`:/^merge/i.test(t)?`merge`:`other`}var ju={feature:new Z(4890367),fix:new Z(16755251),refactor:new Z(4902863),docs:new Z(12303325),test:new Z(6088826),ci:new Z(10514165),style:new Z(16740008),merge:new Z(13217899),other:new Z(10070732)},Mu=[],Nu=new Map,Pu=null;function Fu(e){Pu=e}function Iu(e){if(!Pu)return 1;if(e.userData.repoName===Pu)return .15;let t=Mu.find(e=>e.userData.repoName===Pu);if(!t)return 1;let n=e.position.distanceTo(t.position);return n<30?.3:n<60?.6:1}function Lu(e,t,n){let r=e.length,i=Math.PI*(3-Math.sqrt(5)),a=1;for(let[,e]of t)a=Math.max(a,e.length);for(let n=0;n<r;n++){let o=e[n],s=t.get(o.name)||[],c=1-n/(r-1||1)*2,l=Math.sqrt(1-c*c),u=i*n,d=new q(l*Math.cos(u)*50,c*50,l*Math.sin(u)*50),f=Hu(o,s,d,a);Mu.push(f),Nu.set(o.name,{name:o.name,description:o.description||`No description`,language:o.language||`Unknown`,stars:o.stargazers_count,forks:o.forks_count,commits:s.length,lastPush:o.pushed_at,url:o.html_url,position:d})}}var Ru=null,zu=null;function Bu(){let e=new ia(1.5,24,24);Ru=new Gr({color:new Z(16757575),transparent:!0,opacity:.08,blending:2,depthWrite:!1});let t=new ri(e,Ru);Bl.add(t);let n=new ia(5,24,24);zu=new Gr({color:new Z(1706558),transparent:!0,opacity:.04,blending:2,depthWrite:!1});let r=new ri(n,zu);Bl.add(r);let i=new Float32Array(600);for(let e=0;e<200;e++){let t=Math.random()*Math.PI*2,n=3+Math.random()*8;i[e*3]=n*Math.cos(t),i[e*3+1]=(Math.random()-.5)*2,i[e*3+2]=n*Math.sin(t)}let a=new hr;a.setAttribute(`position`,new er(i,3));let o=new zi(a,new Pi({color:16757575,size:.3,sizeAttenuation:!0,transparent:!0,opacity:.12,blending:2,depthWrite:!1}));Bl.add(o)}function Vu(e){if(Ru){let t=.5+.5*Math.sin(e*.8);Ru.opacity=.05+t*.06}if(zu){let t=.5+.5*Math.sin(e*.5+1);zu.opacity=.02+t*.03}}function Hu(e,t,n,r){let i=new pn;i.position.copy(n),i.userData={repoName:e.name};let a=ku[e.language]||ku.default,o=3+t.length/r*4,s=t.length>15,c=t.length<5?2.5:t.length<15?1.8:t.length<50?1.3:1,l=new ri(new ia(o*.12,16,16),new Gr({color:a.clone().lerp(new Z(16777215),.3),transparent:!0,opacity:.25,blending:2,depthWrite:!1}));i.add(l);let u=document.createElement(`canvas`);u.width=128,u.height=128;let d=u.getContext(`2d`),f=d.createRadialGradient(64,64,0,64,64,64),p=a;f.addColorStop(0,`rgba(${Math.round(p.r*255)},${Math.round(p.g*255)},${Math.round(p.b*255)},0.2)`),f.addColorStop(.2,`rgba(${Math.round(p.r*255)},${Math.round(p.g*255)},${Math.round(p.b*255)},0.08)`),f.addColorStop(.5,`rgba(${Math.round(p.r*255)},${Math.round(p.g*255)},${Math.round(p.b*255)},0.02)`),f.addColorStop(1,`rgba(0,0,0,0)`),d.fillStyle=f,d.fillRect(0,0,128,128);let m=new Fr(new xr({map:new Hi(u),transparent:!0,blending:2,depthWrite:!1}));if(m.scale.set(o*2.5,o*2.5,1),i.add(m),t.length>0){let e=t.length,n=new Float32Array(e*3),r=new Float32Array(e*3),l=Date.now();for(let i=0;i<e;i++){let c=t[i],u=ju[Au(c.commit?.message||``)],d=(l-new Date(c.commit?.author?.date||l).getTime())/864e5,f,p,m;if(s){let t=i%2,n=i/e,r=t*Math.PI+n*Math.PI*4,a=(.15+n*.85)*o*1.6,s=(Math.random()-.5)*o*.4,c=(Math.random()-.5)*o*.08;f=a*Math.cos(r)+s,p=c,m=a*Math.sin(r)+s}else{let e=Math.random()**.5*o*1.2,t=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1);f=e*Math.sin(n)*Math.cos(t),p=e*Math.cos(n)*.2,m=e*Math.sin(n)*Math.sin(t)}n[i*3]=f,n[i*3+1]=p,n[i*3+2]=m;let h=u.clone().lerp(a,.2),g=Math.min(1,d/180),_=h.lerp(new Z(15247436),g*.12);d<7?_.lerp(new Z(16777215),.3):d<30&&_.lerp(new Z(16777215),.1),r[i*3]=_.r,r[i*3+1]=_.g,r[i*3+2]=_.b}let u=new fn,d=new hi(new na(.3*c,0),new Gr({transparent:!0,opacity:.85,blending:2,depthWrite:!1}),e);for(let t=0;t<e;t++)u.position.set(n[t*3],n[t*3+1],n[t*3+2]),u.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),u.updateMatrix(),d.setMatrixAt(t,u.matrix),d.setColorAt(t,new Z(r[t*3],r[t*3+1],r[t*3+2]));d.instanceMatrix.needsUpdate=!0,d.instanceColor&&(d.instanceColor.needsUpdate=!0),d.count=0;let f=0;hu(t=>{if(f>=1)return;f+=t/1.5,f>1&&(f=1);let n=1-(1-f)**3;d.count=Math.floor(n*e)}),i.add(d)}if(t.length>5){let e=Math.min(80,t.length),n=new Float32Array(e*3);for(let t=0;t<e;t++){let e=(.5+Math.random())*o*1.3,r=Math.random()*Math.PI*2;n[t*3]=e*Math.cos(r)+(Math.random()-.5)*o*.4,n[t*3+1]=(Math.random()-.5)*o*.12,n[t*3+2]=e*Math.sin(r)+(Math.random()-.5)*o*.4}let r=new hr;r.setAttribute(`position`,new er(n,3));let s=new Pi({color:a.clone().lerp(new Z(16777215),.5),size:.2,sizeAttenuation:!0,transparent:!0,opacity:.15,blending:2,depthWrite:!1});i.add(new zi(r,s))}return Bl.add(i),i}var Uu=[];function Wu(e){let t=e.dailyCommits,n=Object.keys(t).sort();if(n.length<2)return;let r=[],i=[n[0]];for(let e=1;e<n.length;e++){let t=new Date(n[e-1]),a=new Date(n[e]);Math.floor((a-t)/864e5)<=1?i.push(n[e]):(i.length>=4&&r.push([...i]),i=[n[e]])}i.length>=4&&r.push(i),r.sort((e,t)=>t.length-e.length);let a=r.slice(0,5);for(let e=0;e<a.length;e++){let n=a[e],r=Math.min(1,n.length/14),i=n.map(e=>{let t=Math.floor((new Date(e)-new Date(e.slice(0,4)+`-01-01`))/864e5),n=Math.PI*(3-Math.sqrt(5)),r=1-t/365*2,i=Math.sqrt(1-r*r),a=n*t;return new q(i*Math.cos(a)*52,r*52,i*Math.sin(a)*52)}),o=new ea(i,!1,`centripetal`,.5),s=o.getPoints(50),c=new hr().setFromPoints(s);c.setDrawRange(0,0);let l=new wi({color:new Z(16762960),transparent:!0,opacity:.3+r*.3,blending:2,depthWrite:!1}),u=new Mi(c,l);Bl.add(u);let d=new wi({color:new Z(4890367),transparent:!0,opacity:.06+r*.1,blending:2,depthWrite:!1,linewidth:1}),f=new Mi(c.clone(),d);f.geometry.setDrawRange(0,0),Bl.add(f);let p=[],m=[];for(let e=0;e<i.length;e++){let a=t[n[e]]||1,o=new ta(.35+Math.min(a/8,.8)+r*.15,0),s=Math.min(1,a/10),c=new Gr({color:new Z().lerpColors(new Z(8961023),new Z(16766720),s),transparent:!0,opacity:.7+s*.3,blending:2,depthWrite:!1,wireframe:!0}),l=new ri(o,c);l.position.copy(i[e]),l.visible=!1,Bl.add(l),p.push(c),m.push(l)}let h=2+Math.floor(r*3),g=[],_=[],v=[],y=document.createElement(`canvas`);y.width=64,y.height=64;let b=y.getContext(`2d`),x=b.createRadialGradient(32,32,0,32,32,32);x.addColorStop(0,`rgba(255, 255, 255, 1.0)`),x.addColorStop(.08,`rgba(180, 220, 255, 0.95)`),x.addColorStop(.2,`rgba(255, 200, 80, 0.7)`),x.addColorStop(.4,`rgba(255, 170, 50, 0.3)`),x.addColorStop(.65,`rgba(74, 158, 255, 0.08)`),x.addColorStop(1,`rgba(0, 0, 0, 0)`),b.fillStyle=x,b.fillRect(0,0,64,64);let S=new Hi(y);for(let e=0;e<h;e++){let t=new xr({map:S,transparent:!0,blending:2,depthWrite:!1,opacity:0}),n=new Fr(t),a=1+r*1.5;n.scale.set(a,a,1),n.position.copy(i[0]),n.visible=!1,Bl.add(n),g.push(t),_.push(n),v.push(e/h)}Uu.push({curve:o,curveGeo:c,glowGeo:f.geometry,curveLength:o.getLength(),lineMat:l,glowMat:d,nodeMats:p,nodeMeshes:m,pulseSprites:_,pulseMats:g,pulsePhases:v,pulseCount:h,intensity:r,speed:.08+r*.12,nodePositions:i,birthT:0})}}function Gu(e,t){for(let n of Uu){if(n.birthT<1){n.birthT+=e/2,n.birthT>1&&(n.birthT=1);let t=1-(1-n.birthT)**3,r=Math.floor(t*51);n.curveGeo.setDrawRange(0,r),n.glowGeo.setDrawRange(0,r);for(let e=0;e<n.nodeMeshes.length;e++){let r=e/(n.nodeMeshes.length-1||1);n.nodeMeshes[e].visible=t>=r}if(t>.1)for(let e of n.pulseSprites)e.visible=!0}let r=.5+.5*Math.sin(t*1.5+n.intensity*10);n.lineMat.opacity=(.2+n.intensity*.25)*(.6+r*.4),n.glowMat.opacity=(.06+n.intensity*.1)*(.4+r*.6);for(let e=0;e<n.nodeMats.length;e++){let r=t*2+e*1.7,i=.5+.5*Math.sin(r);n.nodeMats[e].opacity=.3+i*.6*n.intensity}for(let r=0;r<n.pulseCount;r++){n.pulsePhases[r]+=e*n.speed,n.pulsePhases[r]>1&&--n.pulsePhases[r];let i=n.pulsePhases[r],a=n.curve.getPointAt(i);n.pulseSprites[r].position.copy(a);let o=Math.min(i*5,(1-i)*5,1),s=.7+.3*Math.sin(t*8+r*3.14);n.pulseMats[r].opacity=o*s*(.5+n.intensity*.5);let c=(1+n.intensity*1.5)*(.8+.4*Math.sin(t*6+r*2));n.pulseSprites[r].scale.set(c,c,1)}}}function Ku(e,t,n){let r=1200;e.width=r*2,e.height=630*2;let i=e.getContext(`2d`);i.scale(2,2),i.fillStyle=`#060610`,i.fillRect(0,0,r,630);let a=i.createRadialGradient(r/2,630/2,0,r/2,630/2,r*.6);a.addColorStop(0,`rgba(30, 20, 60, 0.3)`),a.addColorStop(1,`rgba(6, 6, 16, 0)`),i.fillStyle=a,i.fillRect(0,0,r,630);try{let e=Hl.domElement;i.globalAlpha=.6,i.drawImage(e,0,0,r,630),i.globalAlpha=1}catch{}let o=i.createLinearGradient(0,0,0,630);o.addColorStop(0,`rgba(6, 6, 16, 0.3)`),o.addColorStop(.5,`rgba(6, 6, 16, 0.1)`),o.addColorStop(.85,`rgba(6, 6, 16, 0.7)`),o.addColorStop(1,`rgba(6, 6, 16, 0.9)`),i.fillStyle=o,i.fillRect(0,0,r,630),i.fillStyle=`#c9b06b`,i.font=`500 24px Georgia, serif`,i.fillText(`Ω`,40,52),i.fillStyle=`#8a8aa0`,i.font=`600 14px Inter, sans-serif`,i.letterSpacing=`4px`,i.fillText(`DRIFT`,68,50),i.fillStyle=`#e8e6e3`,i.font=`500 14px Inter, sans-serif`,i.textAlign=`right`,i.fillText(`@${t.login}`,r-90,55),i.textAlign=`left`;let s=r-40-40;if(i.beginPath(),i.arc(s+40/2,50,40/2,0,Math.PI*2),i.fillStyle=`#1a1a2e`,i.fill(),i.strokeStyle=`rgba(201, 176, 107, 0.3)`,i.lineWidth=1,i.stroke(),t.avatar_url){let e=new Image;e.crossOrigin=`anonymous`,e.onload=()=>{i.save(),i.beginPath(),i.arc(s+40/2,50,40/2,0,Math.PI*2),i.clip(),i.drawImage(e,s,30,40,40),i.restore(),i.beginPath(),i.arc(s+40/2,50,40/2,0,Math.PI*2),i.strokeStyle=`rgba(201, 176, 107, 0.5)`,i.lineWidth=1.5,i.stroke()},e.src=t.avatar_url}i.fillStyle=`#c9b06b`,i.textAlign=`center`,i.font=`300 12px Georgia, serif`,i.fillText(`Ω`,r/2-90,630*.45),i.fillText(`Ω`,r/2+90,630*.45),i.font=`300 12px Inter, sans-serif`,i.fillText(`Y O U R   U N I V E R S E`,r/2,630*.45),i.textAlign=`left`;let c=[{value:n.totalCommits.toLocaleString(),label:`COMMITS`},{value:n.totalRepos.toString(),label:`REPOS`},{value:`${n.maxStreak}d`,label:`MAX STREAK`},{value:`${n.topLanguage} (${n.topLanguagePct}%)`,label:`TOP LANGUAGE`},{value:n.activeDays.toString(),label:`ACTIVE DAYS`}],l=r/(c.length+1);c.forEach((e,t)=>{let n=l*(t+.8);i.fillStyle=`#e8e6e3`,i.font=`700 28px Inter, sans-serif`,i.textAlign=`center`,i.fillText(e.value,n,530),i.fillStyle=`#4a4a6a`,i.font=`500 9px Inter, sans-serif`,i.fillText(e.label,n,548)}),i.textAlign=`left`,i.fillStyle=`#4a4a6a`,i.textAlign=`center`,i.font=`400 10px Georgia, serif`,i.fillText(`Ω`,r/2-120,606),i.font=`400 10px Inter, sans-serif`,i.fillText(`DRIFT — your code has a pulse  ·  drift.veritas.dev`,r/2+8,606),i.textAlign=`left`,i.strokeStyle=`rgba(201, 176, 107, 0.15)`,i.lineWidth=1,i.beginPath(),i.moveTo(40,500),i.lineTo(r-40,500),i.stroke()}async function qu(e){try{let t=await new Promise(t=>e.toBlob(t,`image/png`));return await navigator.clipboard.write([new ClipboardItem({"image/png":t})]),!0}catch{return!1}}function Ju(e,t){let n=document.createElement(`a`);n.download=`drift-${t}-universe.png`,n.href=e.toDataURL(`image/png`),n.click()}var Yu=document.getElementById(`landing`),Xu=document.getElementById(`loading`),Zu=document.getElementById(`hud`),Qu=document.getElementById(`toast`),$u=document.getElementById(`tooltip`),ed=document.getElementById(`username-input`),td=document.getElementById(`launch-btn`),nd=document.getElementById(`progress-fill`),rd=document.getElementById(`loading-detail`),id=document.getElementById(`hud-user`),ad=document.getElementById(`hud-stats`),od=document.getElementById(`share-modal`),sd=document.getElementById(`share-canvas`),cd=document.getElementById(`galaxy-panel`),ld=document.getElementById(`galaxy-detail`),ud=document.getElementById(`drift-canvas`),dd=null,fd=null,pd=new oo;iu(ud),Eu(),yu(),td.addEventListener(`click`,md),ed.addEventListener(`keydown`,e=>{e.key===`Enter`&&md()});async function md(){let e=ed.value.trim();if(!e){ed.focus();return}Yu.classList.add(`hidden`),Xu.classList.remove(`hidden`),_d(5,`Fetching profile...`);try{let t=await o(e);dd=t,_d(15,`Fetching repositories...`);let n=await s(e,e=>_d(25,e));if(n.length===0){Du(),_d(100,`Empty universe — but something is here, waiting`),await xd(1e3),Xu.classList.add(`hidden`),Zu.classList.remove(`hidden`),id.textContent=`@${t.login}`,ad.innerHTML=[hd(`0`,`COMMITS`,`stat-commits`),hd(`0`,`REPOS`,`stat-repos`),hd(`—`,`MAX STREAK`,`stat-streak`),hd(`—`,`TOP LANG`),hd(`0`,`ACTIVE DAYS`,`stat-days`)].join(``);return}_d(35,`Found ${n.length} repositories`);let r=await l(e,n,e=>{let t=parseInt(e.match(/(\d+)%/)?.[1]??`0`,10),n=35+Math.round(t*.5);_d(Math.min(85,n),e)});_d(88,`Computing statistics...`);let i=u(n,r);fd=i,_d(92,`Building galaxies...`),Du(),Bu(),Lu(n,r,i),_d(96,`Drawing constellations...`),Wu(i),_d(100,`Universe ready`),await xd(500),Xu.classList.add(`hidden`),Zu.classList.remove(`hidden`),id.textContent=`@${t.login}`,ad.innerHTML=[hd(`0`,`COMMITS`,`stat-commits`),hd(`0`,`REPOS`,`stat-repos`),hd(`0d`,`MAX STREAK`,`stat-streak`),hd(`${i.topLanguage}`,`TOP LANG`),hd(`0`,`ACTIVE DAYS`,`stat-days`)].join(``),gd(`stat-commits`,i.totalCommits,2e3),gd(`stat-repos`,i.totalRepos,1500),gd(`stat-streak`,i.maxStreak,1800,`d`),gd(`stat-days`,i.activeDays,1600),vd()}catch(t){console.error(`Launch error:`,t);let n=`Something went wrong.`;t.message===`USER_NOT_FOUND`?n=`User "${e}" not found on GitHub.`:t.message===`NO_REPOS`?n=`User "${e}" has no public repositories.`:t.message.startsWith(`RATE_LIMITED`)&&(n=`GitHub API rate limited. ${t.message.split(`: `)[1]}`),bd(n),Xu.classList.add(`hidden`),Yu.classList.remove(`hidden`)}}function hd(e,t,n=``){return`<div class="stat-item"><div class="stat-value"${n?` id="${n}"`:``}>${e}</div><div class="stat-label">${t}</div></div>`}function gd(e,t,n=1500,r=``){let i=document.getElementById(e);if(!i)return;let a=performance.now();function o(e){let s=e-a,c=Math.min(s/n,1),l=1-(1-c)**4;i.textContent=Math.floor(l*t).toLocaleString()+r,c<1?requestAnimationFrame(o):i.textContent=t.toLocaleString()+r}requestAnimationFrame(o)}function _d(e,t){nd.style.width=`${e}%`,rd.textContent=t}document.getElementById(`btn-home`).addEventListener(`click`,()=>{_u(),cd.classList.add(`hidden`)}),document.getElementById(`btn-share`).addEventListener(`click`,()=>{!dd||!fd||(_u(),bd(`Framing universe...`),setTimeout(()=>{Ku(sd,dd,fd),od.classList.remove(`hidden`)},1600))}),document.getElementById(`btn-back`).addEventListener(`click`,()=>{window.location.reload()}),document.getElementById(`close-share`).addEventListener(`click`,()=>{od.classList.add(`hidden`)}),document.getElementById(`btn-copy-share`).addEventListener(`click`,async()=>{bd(await qu(sd)?`Ω Copied to clipboard`:`Copy failed — try download instead`)}),document.getElementById(`btn-download-share`).addEventListener(`click`,()=>{Ju(sd,dd?.login||`user`),bd(`Ω Downloaded`)}),document.getElementById(`close-galaxy`).addEventListener(`click`,()=>{cd.classList.add(`hidden`)});function vd(){let e=null;ud.addEventListener(`mousemove`,t=>{let n=bu(t.clientX,t.clientY,pd),r=null;for(let e of Mu)if(n.intersectObjects(e.children,!0).length>0){r=e.userData.repoName;break}if(r&&r!==e){e=r,Fu(r);let t=Nu.get(r);if(t){let e=Cd(t.lastPush,t.commits);$u.innerHTML=`
        ...
        `,$u.classList.remove(`hidden`)}ud.style.cursor=`pointer`}else !r&&e&&(e=null,Fu(null),$u.classList.add(`hidden`),ud.style.cursor=`grab`);$u.classList.contains(`hidden`)||($u.style.left=`${t.clientX+16}px`,$u.style.top=`${t.clientY-10}px`)}),ud.addEventListener(`click`,e=>{let t=bu(e.clientX,e.clientY,pd);for(let e of Mu)if(t.intersectObjects(e.children,!0).length>0){let t=e.userData.repoName,n=Nu.get(t);n&&(gu(n.position),yd(n));break}})}function yd(e){ld.innerHTML=`
    ...
    <div class="galaxy-meta">
      ...
      <div class="galaxy-meta-item">Last push <strong>${Sd(e.lastPush)}</strong></div>
    </div>
  `,cd.classList.remove(`hidden`)}function bd(e){Qu.textContent=e,Qu.classList.remove(`hidden`),setTimeout(()=>Qu.classList.add(`hidden`),3500)}function xd(e){return new Promise(t=>setTimeout(t,e))}function Sd(e){if(!e)return`unknown`;let t=new Date(e),n=new Date,r=Math.floor((n-t)/864e5);return r===0?`today`:r===1?`yesterday`:r<7?`${r}d ago`:r<30?`${Math.floor(r/7)}w ago`:r<365?`${Math.floor(r/30)}mo ago`:`${Math.floor(r/365)}y ago`}hu((e,t)=>{for(let t of Mu){let n=Iu(t);t.rotation.y+=e*.05*n}Gu(e,t),Ou(t),Vu(t)});function Cd(e,t){if(!e)return{label:`unknown`,class:`dormant`};let n=Math.floor((Date.now()-new Date(e).getTime())/864e5);return n<=1&&t>20?{label:`🔥 exploding`,class:`alive`}:n<=1?{label:`⚡ firing`,class:`alive`}:n<=7&&t>20?{label:`⚡ surging`,class:`alive`}:n<=7?{label:`✨ active`,class:`active`}:n<=30?{label:`quiet`,class:`quiet`}:n<=90&&t<5?{label:`🌱 emerging`,class:`active`}:n<=90?{label:`resting`,class:`quiet`}:n<=365&&t<3?{label:`🌱 emerging`,class:`active`}:n<=365?{label:`dormant`,class:`dormant`}:t>50?{label:`archived`,class:`dormant`}:{label:`deep sleep`,class:`dormant`}}